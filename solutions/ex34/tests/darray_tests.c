...
char *test_new()
{
	...
	mu_assert(val1 != NULL, "failed to make a new elemtent");

	val2 = DArray_new(array);
	mu_assert(val2 != NULL, "failed to makde a new element");
...
char *test_remove()
{
	...
	mu_assert(DArray_get(array, 0) == NULL, "Shoudl be gone.");
	...
	*val_check = DArray_remove(array, 1);
	...
	mu_assert(DArray_get(array, 1) == NULL, "Shoudl be gone.");
